...
if(isset($_GET['edit_pro'])){
    ...
    $get_pro = "select * from guitar_product where guitar_Id='$get_id'";
    $run_pro = mysqli_query($con, $get_pro);
    $row_pro = mysqli_fetch_array($run_pro);
    $pro_id = $row_pro['guitar_id'];
    $pro_title = $row_pro['guitar_title'];
    $pro_cat = $row_pro['guitar_cat'];
    $pro_brand = $row_pro['guitar_brand'];
    $pro_title = $row_pro['guitar_title'];
    $pro_price = $row_pro['guitar_price'];
    $pro_image = $row_pro['guitar_image'];
    $pro_key = $row_pro['guitar_keyword'];

    $get_cat = "select * from guitar_categories where cat_Id = '$pro_cat'";
    $run_cat = mysqli_query($con,$get_cat);
    $row_cat = mysqli_fetch_array($run_cat);
    $cat_title = $row_cat['cat_title'];

    $get_brand = "select * from guitar_brand where brand_Id = '$pro_brand'";
...
//getting text data from the fields
    $pro_title = $_POST['dre_title'];
    $pro_cat = $_POST['dre_cat'];
    $pro_brand = $_POST['dre_brand'];
    $pro_price = $_POST['dre_price'];
    $pro_keywords = $_POST['dre_keywords'];
//getting image from the field
    $pro_image = $_FILES['dre_image']['name'];
    $pro_image_tmp = $_FILES['dre_image']['tmp_name'];

    move_uploaded_file($pro_image_tmp,"Images/$pro_image");

    $update_product = "update products set guitar_cat = '$pro_cat',
guitar_brands = '$pro_brand',
guitar_title = '$pro_title' ,
guitar_price = '$pro_price',
guitar_desc = '$pro_desc',
guitar_image = '$pro_image',
guitar_keyword = '$pro_keywords'
where guitar_id='$pro_id'";
